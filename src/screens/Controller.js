...
export default function Controller() {
    ...
    const [upcomingMovie, setUpcomingMovie] = useState([
        ...
        },
        {
            ...
            language: 'Tamil',
            released: 'yes',
            releasedDate: '30-09-2022',
            imdb: '9',
            category: 'Movies',
            genre: ['action', 'adventure', 'super-hero'],
            imageUrl: 'https://m.media-amazon.com/images/M/MV5BYmIzZTg5Y2YtMjQ0MC00YTcyLWExZGQtMTJkOTljODc0NmIyXkEyXkFqcGdeQXVyMTA3MDk2NDg2._V1_.jpg',
        },
        {
            id: 3,
        ...
        },
        {
            ...
            artists: [
                ...
                },
                {
                    ...
                    "artistImage": 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Arjun_mathur.jpg/800px-Arjun_mathur.jpg',
                },
                {
                    id: 3,
        ...
        },
        {
            ...
            artists: [
                ...
                },
                {
                    ...
                    "artistImage": 'https://upload.wikimedia.org/wikipedia/commons/9/93/RupertGrint2018.jpg'
                },
                {
                    id: 4,
